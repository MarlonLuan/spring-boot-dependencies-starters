...
./mvnw -f starterdependency/pom.xml help:effective-pom -Doutput=effective-pom.xml
...
./mvnw -f starterdependency/pom.xml dependency:tree -DoutputFile=dependency-tree.txt
...
./mvnw -f starterdependency/pom.xml dependency:resolve-plugins -DoutputFile=resolve-plugins.txt
